//Пример REST сервера с несколькими маршрутами. Используем gorilla/mux.
...
// renderJSON преобразует 'v' в JSON  и записывает значение, как ответ, в w.
...
func (ts *taskServer) createTaskHandler(w http.ResponseWriter, req *http.Request) {
	...
	//Content-Type будет использовать JSON.
