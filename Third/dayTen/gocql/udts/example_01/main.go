...
const USERS_TABLE = `CREATE TABLE example.users2 (
user_id int PRIMARY KEY,
name text,
email text,
Laptop frozen<Laptop>)`

const INSERT = `INSERT INTO example.users2 (
...
func main() {
	...
	err = session.Query("select laptop from users2 where user_id=1").Scan(&retrieved)
